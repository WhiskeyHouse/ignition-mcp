...
class IgnitionAPIGenerator:
    ...
    def __init__(self, openapi_spec_path: str = None):
        if openapi_spec_path is None:
            ...
            openapi_spec_path = module_dir / "ignition_openapi.json"
                ...
                if schema.get('type') == 'object':
                    ...
                    for prop_name, prop_schema in body_props.items():
                        properties[f"body_{prop_name}"] = {
                            ...
                            'description': prop_schema.get('description', f"{prop_name} in request body")
                        }
    ...
    def save_tools_summary(self, output_path: str = "ignition_tools_summary.json"):
